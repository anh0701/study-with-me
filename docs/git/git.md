...
> **Git**: công cụ quản lý phiên bản phân tán.  
...
- **Hotfix branches**: Nhánh sửa lỗi khẩn cấp. Khi phát hiện lỗi trong phiên bản đã phát hành, bạn có thể tạo nhánh hotfix để sửa lỗi mà không ảnh hưởng đến các nhánh khác.
