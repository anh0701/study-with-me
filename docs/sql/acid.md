...
### 1.2. Consistency (Tính nhất quán) – "Đúng quy tắc"
...
### 1.3. Isolation (Tính cô lập) – "Việc ai nấy làm"
...
### 1.4. Durability (Tính bền vững) – "Lưu là lưu luôn"
...
## 2. Những lỗi thường gặp khi dùng ACID
